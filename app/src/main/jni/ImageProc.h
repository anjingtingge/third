...
void Java_com_camera_simplewebcam_CameraPreview_processCamera( JNIEnv* env,jobject thiz,const jbyteArray videodata);
...
//dwins
void Java_com_camera_simplewebcam_CameraPreview_takepicture( JNIEnv* env,jobject thiz,const jbyteArray videodata);